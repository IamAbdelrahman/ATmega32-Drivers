...
const ST_GPIOConfig_t KEYPADConfig[] = {
    /*   PORT      PIN	   STATE    */
    {KEYPAD_PORT, Pin0, GPIO_OUTPUT},
    {KEYPAD_PORT, Pin1, GPIO_OUTPUT},
    {KEYPAD_PORT, Pin2, GPIO_OUTPUT},
    {KEYPAD_PORT, Pin3, GPIO_OUTPUT},
    {KEYPAD_PORT, Pin4, GPIO_INPUT_PULLUP},
    {KEYPAD_PORT, Pin5, GPIO_INPUT_PULLUP},
    {KEYPAD_PORT, Pin6, GPIO_INPUT_PULLUP},
    {KEYPAD_PORT, Pin7, GPIO_INPUT_PULLUP}};
/**********************************************************************
