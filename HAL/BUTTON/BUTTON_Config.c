 ...
 * This table is read in by BUTTON_Init(), where each pin is then set up based on this table.
 */
const ST_GpioConfig_t BUTTONConfig[] = {
/*   PORT            PIN					STATE			*/
    {PORTA,          BUTTON0,                  DIO_INPUT_FLOATING},
...
const ST_GpioConfig_t* const BUTTON_ConfigGet(void) {
	return (ST_GpioConfig_t *const)&BUTTONConfig[0];
}
