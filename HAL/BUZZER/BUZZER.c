 ...
 *  @return void
 **********************************************************************/
void BUZZER_On(EN_GpioX_t Port, EN_GpioPin_t Pin) {
 ...
 *  @return void
 **********************************************************************/
void BUZZER_Off(EN_GpioX_t Port, EN_GpioPin_t Pin) {
	DIO_PinWrite(Port, Pin, LOW);
}

/**********************************************************************
 * Function : BUZZER_Toggle()
 *
 *  Description:
 *  This function is used to toggle a buzzer connected to the MCU's channel(pin)
 *
 *  PRE-CONDITION: The channel is configured as OUTPUT
 *  PRE-CONDITION: The channel is configured and initialized as DIO
 *  PRE-CONDITION: The channel is within the maximum DIOPin_t definition
 ...
 *  @return void
 **********************************************************************/
void BUZZER_Toggle(EN_GpioX_t Port, EN_GpioPin_t Pin) {
