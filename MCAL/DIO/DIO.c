 ...
 *  logic high or low through the use of the DIOPin_t enum
 *
 *  PRE-CONDITION: The channel is configured as OUTPUT
 *  PRE-CONDITION: The channel is configured as DIO
 *  PRE-CONDITION: The channel is within the maximum DIOPin_t definition
 ...
 *  @return void
 **********************************************************************/
void DIO_PinToggle(EN_GpioX_t Port, EN_GpioPin_t Pin) {
 ...
 *
 *  Description:
 *  This function is used to reset all the DIO Registers

 *  @param Port is the port to be reset using the GpioX_t enum definition

 *  @return void
 **********************************************************************/
void DIO_Reset (EN_GpioX_t Port) {
    *(Data[Port]) = 0x00;
    *(DataDir[Port]) = 0x00;
}
 ...
 *
 *  Description:
 *  This function is used to read the whole PIN register in DIO

 *  @param Port is the port to be read using the GpioX_t enum definition

 *  @return the value of the 16-bit register
 **********************************************************************/
vuint8_t DIO_ReadPort (EN_GpioX_t Port) {
    return (vuint8_t) (*DataIn[Port]);
}
